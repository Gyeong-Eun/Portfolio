...
- 기사 본문을 반영한 헤드라인을 생성하여 기존 선정적 헤드라인의 평균 선정성 수치는 0.99였으나, 새로 생성한 헤드라인의 평균 선정성 수치는 0.25로 74.7% 감소
<br>
...
- 판별 모델 파인튜닝 : LMkor-BERT를 선정성 판별 모델로 활용하기 위해 성능 개선을 진행
- 생성 모델 프롬프트 엔지니어링 : GPT-4 Turbo가 제목을 비선정적으로 재생성하지 못하는 문제를 해결하기 위한 프롬프트 설계에 기여
<br>
